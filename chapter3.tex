...
As mentioned in Section \ref{chap2}, three machine learning algorithm have been used to train models used to predict glaciers ice thickness. The same procedure has been applied to all the algorithm used, in order to compare the results between the different models. 
