...
After training each algorithm the resulting model has been used to predict the ice volume of all the glaciers in the Alps. This is useful to compare the results of these models to those computed by \citet{Farinotti2019} in the third ITMIX.
...
The total volume for glaciers in the Alps computed with the linear model is $1.40 \times 10^{11}m^3$, which is 9.8\% larger than the volume predicted by \citet{Farinotti2019}.
